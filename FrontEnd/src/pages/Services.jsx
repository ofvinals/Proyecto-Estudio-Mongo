...
export const Services = () => {
	return (
		<>
			<Header />
			<section className='bg-gradient-to-tl from-[#8c8e8f] to-background pt-28 flex flex-wrap h-auto items-center justify-center flex-col pb-10'>
				<Whatsapp />
				<h2 className='text-center bg-gradient-to-t from-primary to-black text-transparent bg-clip-text text-3xl font-bold mt-5 pb-10'>
					Servicios
				</h2>
