		...
		<>
			<div className='bg-gradient-to-tl from-[#1e1e1e] to-[#4077ad]'>
				...
				<div className='flex flex-wrap items-center justify-around mt-3'>
					<Link
						className='bg-white shadow-3xl btnAdmin text-primary text-center p-2 border-2 w-[230px] mb-3 border-primary rounded-xl font-bold'
					...
					<button
						...
						className='bg-background btnLogout text-white text-center p-2 border-2 w-[200px] mb-3 border-white rounded-xl font-bold'>
