				...
				<Modal.Body>
					<Form className='flex flex-col flex-wrap justify-around items-start'>
						<Form.Group className='flex flex-row mb-3 items-center justify-around' id='expte'>
							<Form.Label className='text-start bg-transparent text-xl mb-0 mt-2 text-background w-full font-medium'>Nro Expte <span className='text-black'>{gasto.nroexpte}</span></Form.Label>
						</Form.Group>
						<Form.Group className='flex flex-row mb-3 items-center justify-around' id='concepto'>
							<Form.Label className='text-start bg-transparent text-xl mb-0 mt-2 text-background w-full font-medium'>Concepto <span className='text-black'>{gasto.concepto}</span></Form.Label>
						</Form.Group>
						<Form.Group className='flex flex-row mb-3 items-center justify-around' id='monto'>
							<Form.Label className='text-start bg-transparent text-xl mb-0 mt-2 text-background w-full font-medium'>Monto <span className='text-black'>$ {gasto.monto}</span></Form.Label>
						</Form.Group>
